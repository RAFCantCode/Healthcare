...
# ============================================
df = pd.read_excel(r"diabetic_data_QMH_Club_Fest_2025.xlsx", sheet_name="Sheet1")
...
csv_path = os.path.join(output_dir, "cleaned_diabetic_data.csv")
excel_path = os.path.join(output_dir, "cleaned_diabetic_data.xlsx")
